...
Route::middleware(['auth:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['fa.admin'])->group(function () {
        ...
        // Enhanced Finance Admin routes with payment management
        ...
        Route::get('invoice/{id}', [FaController::class, 'generateInvoice'])->name('invoice.generate');
        ...
        Route::post('export-financial-data', [FaController::class, 'exportFinancialData'])->name('export.financial');
        Route::get('fee-structure', [FaController::class, 'feeStructure'])->name('fee.structure');
        Route::post('update-fee-structure', [FaController::class, 'updateFeeStructure'])->name('fee.structure.update');
...
////////////////////////////////////////////////////////////////////
// Test route for Global Admin
Route::get('/test-global-admin', function() {
    try {
        // Test if GlobalAdminController exists and works
        $controller = new App\Http\Controllers\admin\GlobalAdminController();
        $response = $controller->index();
        
        return "GlobalAdminController works! You can access: " . 
               "<br><a href='" . route('admin.global') . "'>Admin Global</a>" .
               "<br><a href='" . route('admin.global.dashboard') . "'>Admin Global Dashboard</a>";
...
Route::get('/test-admin', function() {
    return "Admin area accessible!";
})->middleware('auth:admin');
////////////////////////////////////////////////////////////////////



        // Global Admin routes - COMPLETE FIXED VERSION
    Route::middleware(['global.admin'])->group(function () {
        ...
        Route::get('global', [GlobalAdminController::class, 'index'])->name('global'); // Main dashboard
        Route::get('users', [GlobalAdminController::class, 'users'])->name('users'); // Manage users
        Route::get('applications', [GlobalAdminController::class, 'applications'])->name('applications'); // Manage applications
        
        // NEW ROUTES with /global prefix
        Route::get('global/dashboard', [GlobalAdminController::class, 'index'])->name('global.dashboard');
        
        // User Management
        Route::get('global/users', [GlobalAdminController::class, 'users'])->name('global.users');
        Route::get('global/users/{id}', [GlobalAdminController::class, 'viewUser'])->name('global.users.view');
        
        // Application Management
        Route::get('global/applications', [GlobalAdminController::class, 'applications'])->name('global.applications');
        ...
        Route::get('global/payments/{id}', [GlobalAdminController::class, 'viewPayment'])->name('global.payments.view');
        Route::post('global/payments/{id}/status', [GlobalAdminController::class, 'updatePaymentStatus'])->name('global.payments.update-status');
    ...
    Route::middleware(['teacher.admin'])->group(function () {
        ...
        Route::get('teacher-management', [TeacherController::class, 'teacherManagement'])->name('teacher-management');
    });
