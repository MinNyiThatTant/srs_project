            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @if (auth()->guard('admin')->check() && in_array(auth()->guard('admin')->user()->role, ['global_admin', 'hsa_admin']))
                        ...
                        <!-- Payments - Only for Global Admin and Finance Admin -->
                        @if (auth()->guard('admin')->check() && in_array(auth()->guard('admin')->user()->role, ['global_admin', 'fa_admin']))
                            <li
                                class="sidebar-item {{ request()->routeIs('admin.global.payments') || request()->routeIs('admin.payments.index') ? 'active' : '' }}">
                                <a href="{{ auth()->guard('admin')->user()->role === 'global_admin' ? route('admin.global.payments') : route('admin.payments.index') }}"
                                    class='sidebar-link'>
                        ...
                        <!-- Reports - Only for Global Admin and Finance Admin -->
                        @if (auth()->guard('admin')->check() && in_array(auth()->guard('admin')->user()->role, ['global_admin', 'fa_admin']))
                            <li
                                class="sidebar-item {{ request()->routeIs('admin.global.reports') || request()->routeIs('admin.financial-reports') ? 'active' : '' }}">
                                <a href="{{ auth()->guard('admin')->user()->role === 'global_admin' ? route('admin.global.reports') : route('admin.financial-reports') }}"
                                    class='sidebar-link'>
                        ...
                        @if (auth()->guard('admin')->check() && in_array(auth()->guard('admin')->user()->role, ['global_admin', 'hod_admin']))
                            <li
                                ...
                                <ul class="submenu">
                                    ...
                                    @if (auth()->guard('admin')->user()->role === 'global_admin')
                                        <li
                                            class="submenu-item {{ request()->routeIs('admin.teachers.*') ? 'active' : '' }}">
