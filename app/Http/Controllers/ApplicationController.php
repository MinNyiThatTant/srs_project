...
public function oldStudentForm()
{
    ...
    /**
     * Submit existing student application - CORRECTED VERSION
     */
    public function submitExistingApplication(Request $request)
    {
        ...
        try {
            ...
            $currentYearNum = $this->getYearNumber($student['current_year']);
            ...
            if ($applyingYear !== ($currentYearNum + 1)) {
                return redirect()->back()
                    ...
                    ->with('error', 'Invalid application year. You are currently in ' .
                        $this->getYearNameFromNumber($currentYearNum) .
                        '. Please apply for ' . $this->getYearNameFromNumber($currentYearNum + 1) . '.');
            }
            ...
            // Calculate fee
            $fee = $this->calculateApplicationFee($request->application_purpose, $applyingYear);
            ...
            $emailSent = $this->sendOldStudentApplicationConfirmation($applicationId, $student);
